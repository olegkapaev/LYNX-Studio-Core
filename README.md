...
│
├── database/						# Database storage and SQL scripts (Хранилище баз данных и SQL-скрипты)
│
...
│   ├── fonts/						# Local web fonts library (Локальная библиотека веб-шрифтов)
...
│   │   ├── site.webmanifest		# Mobile PWA manifest (Манифест PWA-приложения)
│   │   └── sitemap.xml				# Search sitemap URL (Поисковая карта сайта)
│   ├── modules/					# Core components (Основные компоненты)
...
│
├── tests/							# Automated testing environment (Среда автоматизированного тестирования)
│   ├── integration/				# Integration tests for subsystem interaction (Интеграционные тесты взаимодействия подсистем)
│   └── unit/						# Unit tests for individual formulas and logic (Юнит-тесты отдельных формул и логики)
│
